...
/**
 * Holidays Library for CodeIgniter
 * 
...
class Holidays implements Iterator
{
    ...
    public function __construct($config)
    {
        ...
        if(is_array($config['extra'])){
            $this->setExtras($config['extra']);
        }

        if(isset($config['observance'])){
            $this->setObservances($config['observance']);
        }

        if(isset($config['easter'])){
            $this->setEaster($config['easter']);
        }

        if(isset($config['good_friday'])){
            $this->setGoodFriday($config['good_friday']);
        }
